...
int main(int argc, char** argv)
{
    ...
    //solver11.solve();
    solver11.solve_with_islands({2, 4, 3, 3, 4, 1, 6, 7, 7});

    fmt::println("\nGrid 11:\n{}", grid11);

    auto const numbers = grid11.get_numbers();

    fmt::println("Numbers: {}, Total: {}", numbers, std::accumulate(numbers.begin(), numbers.end(), uint64_t{0}));
